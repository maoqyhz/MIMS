...
(function($) {
	...
	function _3ed(_3ef, menu) {
		...
		menu._size({
			fit: (menu[0] == _3ef ? opts.fit : false),
			width: _3f1,
	...
	$.fn.menu = function(_419, _41a) {
		...
		return this.each(function() {
			...
			if (_41b) {
				...
				_41b = $.data(this, "menu", {
					options: $.extend({}, $.fn.menu.defaults, $.fn.menu.parseOptions(this), _419)
				});
				init(this);
			}
			$(this).css({
...
(function($) {
	...
	$.fn.menubutton.parseOptions = function(_439) {
		var t = $(_439);
		return $.extend({}, $.fn.linkbutton.parseOptions(_439), $.parser.parseOptions(_439, ["menu",
		{
			plain: "boolean",
...
(function($) {
	...
	$.fn.splitbutton.parseOptions = function(_441) {
		var t = $(_441);
		return $.extend({}, $.fn.linkbutton.parseOptions(_441), $.parser.parseOptions(_441, ["menu",
		{
			plain: "boolean",
			duration: "number"
		}]));
...
(function($) {
	...
	$.fn.searchbox.parseOptions = function(_501) {
		var t = $(_501);
		return $.extend({}, $.fn.textbox.parseOptions(_501), $.parser.parseOptions(_501, ["menu"]), {
