...
$easyuiFileName = Join-Path $packageScriptsFolder "jquery.easyui-*.js" | Get-ChildItem -Exclude "*.min.js","*easyui-lang-*.js" | Split-Path -Leaf
$easyuiFileNameRegEx = "jquery.easyui-((?:\d+\.)?(?:\d+\.)?(?:\d+\.)?(?:\d+)?(?:(?:-\w*)*)).js"
$easyuiFileName -match $easyuiFileNameRegEx
$ver = $matches[1]
